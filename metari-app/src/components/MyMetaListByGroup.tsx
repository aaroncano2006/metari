                        ...
                        <div className="metaDetailsBox my-0 me-3 ">
                          {openEntityId === assignation.id && (
                            ...
                            <div className="metaDetails ps-2 py-2 d-flex flex-column">
                              ...
                              {assignation.user_id &&
                                <div>👤 Assignada a: {assignation.user?.name ? `${assignation.user?.name} (${assignation.user?.username})` : assignation.user_id}</div>
                              }
                              {assignation.assigner_id && (
                                <div>👑 Assignada per: {assignation.assigner?.name ? `${assignation.assigner?.name} (${assignation.assigner?.username})` : assignation.assigner_id}</div>
                              )}
