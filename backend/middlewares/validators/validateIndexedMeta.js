...
const validateIndexedMeta = async (data, isUpdating = false) => {
  ...
  if (data.is_approved !== undefined && typeof data.is_approved !== "boolean" && data.is_approved !== "true" && data.is_approved !== "false") {
    return "El camp is_approved ha de ser un booleà!";
  }
  if (data.is_community_approved !== undefined && typeof data.is_community_approved !== "boolean" && data.is_community_approved !== "true" && data.is_community_approved !== "false") {
